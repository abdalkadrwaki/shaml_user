...
<script>
    (function(){
        // تعريف متغيرات خاصة بالكود الثاني
                ...
                <div id="imageModal_syp" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-90">
                    <div class="relative w-full max-w-3xl p-6 bg-white rounded-lg shadow-2xl">
                        ...
                        <div class="flex justify-between w-full mt-6 space-x-4">
                            <button onclick="secondTransfer.copyData()" class="btn-blue">📋 نسخ البيانات</button>
                            <button onclick="secondTransfer.downloadImage()" class="btn-green">📥 تنزيل الصورة</button>
                            <button onclick="secondTransfer.closeModal()" class="btn-red">❌ إغلاق</button>
                        </div>
                    </div>
                </div>
            `;
     ...
     * الوجهه*
     ...
     ━━━━━━━━━━━━━━━━━━
        ...
        // تصدير الدوال المطلوبة ضمن كائن secondTransfer
        window.secondTransfer = {
            copyData: copyData,
