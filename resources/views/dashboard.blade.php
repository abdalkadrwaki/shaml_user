                        ...
                        <ul class="p-1 mt-1 mb-3 nav nav-pills justify-content-center " id="pills-tab" role="tablist"
                            ...
                            <li class="nav-item" role="presentation" style="flex: 1; margin: 0 5px;">
                                <a class="px-2 py-2 text-center text-white bg-blue-900 nav-link hover:border-blue-500 focus:ring-2 focus:ring-blue-500 aria-selected:bg-blue-700"
                                    ...
                                    role="tab" aria-controls="pills-payment-voucher" aria-selected="false"
                                    style="width: 100%;" data-bs-target="#pills-payment-voucher">
                                    سند صرف
                            ...
                            <div class="tab-pane fade" id="pills-send-request" role="tabpanel"
                                ...
                                <div class="p-4 bg-custom-gray2 shadow-md rounded-md ">
                                    <form id="transfer-form" method="POST"
                                        action="{{ route('dashboard.transfer.submit') }}">
                                        @csrf

                                        <!-- بيانات المستفيد -->
                                        <div class="mb-3 row">
                                            <div class="col-md-6">
                                                <label for="recipient_name_transfer" class="form-label">اسم
                                                    المستفيد</label>
                                                <input type="text" id="recipient_name_transfer" name="recipient_name"
                                                    class="form-control rounded-md  border-gray-300"
                                                    value="{{ old('recipient_name', 'محمد') }}" required>
                                            ...
                                            <div class="col-md-6">
                                                <label for="recipient_mobile_transfer" class="form-label ">جوال
                                                    المستفيد</label>
                                                <input type="tel" id="recipient_mobile_transfer"
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-md-12">
                                                ...
                                                <select id="destination_transfer" name="destination"
                                                    class="form-select js-example-basic-single rounded-md  border-gray-300"
                                                    required>
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-md-6">
                                                <label for="sent_currency_transfer" class="form-label">العملة
                                                    المرسلة</label>
                                                <select id="sent_currency_transfer" name="sent_currency"
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-md-6 ">
                                                <label for="received_currency_transfer" class="form-label">العملة
                                                    المستلمة</label>
                                            ...
                                            <div class="col-md-6">
                                                <label for="received_amount_transfer" class="form-label">المبلغ
                                                    المستلم</label>
                                                <input type="text" id="received_amount_transfer"
                                                    name="received_amount"
                                                    class="form-control number-only bg-gray-200  rounded-md  border-gray-300"
                                                    value="" readonly>
                                        ...
                                        <div class="mb-3 row" id="destination_address_container"
                                            style="display:none;">
                                            <div class="col-md-12">
                                                <label for="destination_address"
                                                    class="form-label  rounded-md  border-gray-300">عنوان الجهة</label>
                                        ...
                                        <div class="row">
                                            <div class="text-center col-md-12">
                                                <button type="submit" class="w-full btn btn-success">إرسال
                                                    الحوالة</button>
                                            </div>
                                        </div>
                                    </form>
                                    ...
                                    <form action="{{ route('exchange.submit') }}" method="POST">
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-md-12">
                                                ...
                                                <select id="destination_exchange" name="destination_exchange"
                                                    class="form-select js-example-basic-single" required>
                                                    <option value="">اختر الجهة</option>
                                                    @foreach ($destinations as $destination)
                                                        <option value="{{ $destination['id'] }}"
                                                            {{ old('destination') == $destination['id'] ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-md-6">
                                                <label for="sent_currency_exchange" class="form-label"> بيع
                                                    العملة</label>
                                                <select id="sent_currency_exchange" class="form-select"
                                                    name="sent_currency" required>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="sent_amount_exchange"
                                                    class="form-control number-only" name="sent_amount"
                                                    lang="en" step="any" value="{{ old('sent_amount') }}"
                                                    required>
                                                <div id="balanceError" class="mt-2 text-danger"
                                                    style="display: none;">
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-md-6">
                                                <label for="received_currency_exchange" class="form-label"> شراء
                                                    العملة</label>
                                                <select id="received_currency_exchange" class="form-select"
                                                    name="received_currency" required>
                                                    <option value="" disabled selected>اختر العملة المستلمة
                                                    </option>
                                                    @foreach ($currencies as $currency)
                                                        <option value="{{ $currency['name_en'] }}"
                                                            {{ old('received_currency') == $currency['name_en'] ? 'selected' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <label for="received_amount_exchange" class="form-label">شراء
                                                    مبلغ</label>
                                                <input type="text" id="received_amount_exchange"
                                                    ...
                                                    name="received_amount" value="{{ old('received_amount') }}"
                                                    readonly>
                                                @error('received_amount')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="exchange_rate_exchange"
                                                    class="form-control number-only" name="exchange_rate"
                                    ...
                                    <form id="Approval-form" method="POST" action="{{ route('approval.submit') }}">
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-md-6">
                                                ...
                                                <select id="sent_currency_approval" class="form-select"
                                                    name="sent_currency" required>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="sent_amount_approval"
                                                    class="form-control number-only" name="sent_amount"
                            ...
                            <div class="tab-pane fade" id="pills-SYP" role="tabpanel"
                                ...
                                <div class="p-4 bg-custom-gray2 shadow-md rounded-md ">
                                    <form id="transfer-form_syp" method="POST" action="{{ route('syp.submit') }}">
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-md-6">
                                                <label for="recipient_name_syp" class="form-label">اسم
                                                    المستفيد</label>
                                            ...
                                            <div class="col-md-6">
                                                <label for="recipient_mobile_syp" class="form-label ">جوال
                                                    المستفيد</label>
                                                <input type="tel" id="recipient_mobile_syp"
                                                    name="recipient_mobile"
                                                    class="form-control  rounded-md  border-gray-300"
                                                    value="{{ old('recipient_mobile', '0596123781') }}" required>
                                                @error('recipient_mobile')
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-md-6">
                                                <label for="sent_currency_syp" class="form-label">العملة
                                                    المرسلة</label>
                                                <select id="sent_currency_syp" name="sent_currency"
                                                    class="form-select rounded-md  border-gray-300" required>
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-md-12">
                                                ...
                                                <label for="received_amount_syp" class="form-label">المبلغ
                                                    المستلم</label>
                                                <input type="text" id="received_amount_syp" name="received_amount"
                                                    class="form-control number-only  rounded-md  border-gray-300 received_amount_syp"
                                                    value="">
                                                @error('received_amount')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-md-6">
                                                <label for="received_currency_syp" class="form-label">العملة
                                                    المستلمة</label>
                                            ...
                                            <div class="col-md-6">
                                                <label for="received_amount_syp" class="form-label">المبلغ
                                                    المستلم</label>
                                                <input type="text" id="received_amount_syp" name="received_amount"
                                                    class="form-control number-only bg-gray-200  rounded-md  border-gray-300 received_amount_syp"
                                                    value="" readonly>
                                                @error('received_amount')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-6" id="destination_address_container1">
                                                ...
                                                <input type="text" id="exchange_rate_syp" name="exchange_rate"
                                                    class="form-control number-only rounded-md border-gray-300"
                                                    value="{{ old('exchange_rate') }}">
                                                @error('exchange_rate')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <!-- عنوان الجهة (مخفي افتراضيًا) -->
                                        <div class="mb-3 row" id="destination_address_container_syp"
                                            style="display:none;">
                                            <div class="col-md-12">
                                                <label for="destination_address"
                                                    class="form-label  rounded-md  border-gray-300">عنوان الجهة</label>
                                ...
                                <script>
                                    document.addEventListener('DOMContentLoaded', function() {
                                        ...
                                        const receivedAmountInput2 = document.querySelectorAll('.received_amount_syp')[
                                        1]; // المبلغ المستلم الثاني
                                        ...
                                        receivedAmountInput1.addEventListener('input', function() {
                                            ...
                                            if (!isNaN(exchangeRate) && this.value && exchangeRate !== 0) {
                                                ...
                                                receivedAmountInput2.value = this
                                                .value; // تحديث المبلغ المستلم الثاني بناءً على المبلغ المستلم الأول
                                            } else {
                                                sentAmountInput.value = '';
                                                receivedAmountInput2.value = '';
                                            }
                                        ...
                                        receivedAmountInput2.addEventListener('input', function() {
                                            ...
                                            if (!isNaN(exchangeRate) && this.value && exchangeRate !== 0) {
                                                const sentAmount = (parseFloat(this.value) / exchangeRate).toFixed(2);
                                                sentAmountInput.value = sentAmount;
                                                receivedAmountInput1.value = this
                                                .value; // تحديث المبلغ المستلم الأول بناءً على المبلغ المستلم الثاني
                                            } else {
                                                sentAmountInput.value = '';
                                                receivedAmountInput1.value = '';
                                            }
