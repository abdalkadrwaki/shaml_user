            ...
            <div class="flex gap-x-8">
                ...
                <div class="hidden sm:flex space-x-6 space-x-reverse">
                    ...
                    <div class="relative">
                        ...
                        <!-- Dropdown Content -->
                        <div
                            class="absolute hidden bg-white dark:bg-gray-800   shadow-lg rounded-md -mt-8 space-y-2    w-40     group-hover:block">
                    ...
                    <div class="relative">
                        ...
                        <!-- Dropdown Content -->
                        <div
                            class="absolute hidden bg-white dark:bg-gray-800   shadow-lg rounded-md mt-1 space-y-2  w-36 group-hover:block">
