        ...
        <div class="flex justify-between h-16">
            <div class="flex gap-x-8">
                ...
                <div class="hidden sm:flex space-x-6 space-x-reverse">
                    ...
                    <div class="relative">
                        <button
                            class="inline-flex items-center px-4 py-2 w-36 mt-3 text-sm font-medium text-gray-800 bg-white hover:bg-gray-50 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-0.5 focus:ring-indigo-500 transition duration-150 ease-in-out">
                            ...
                            <span>{{ __(' حركات واردة') }}</span>
                        </button>

                        <!-- Dropdown Content -->
                        <div class="absolute hidden bg-custom-gray dark:bg-gray-800 shadow-lg rounded-md -mt-10 space-y-10 w-36 group-hover:block mx-2 px-2">
                            ...
                            <x-nav-link
                                ...
                                class="block w-full px-3 py-2 text-sm rounded-md hover:bg-gray-600 dark:hover:bg-gray-700 hover:text-white transition-colors no-underline">
                                <!-- Changed hover:bg-blue-500 to hover:bg-gray-600 -->
                                {{ __(' حوالات واردة ') }}
                            </x-nav-link>
