        ...
        <div class="flex justify-between h-16">
            <div class="flex gap-x-8">
                ...
                <div class="hidden sm:flex space-x-8 space-x-reverse">
                    ...
                    <div class="relative">
                        <button
                            class="inline-flex items-center px-10 py-2 mt-3 text-sm font-medium text-gray-800 bg-white hover:bg-gray-50 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-0.5 focus:ring-indigo-500 transition duration-150 ease-in-out">
