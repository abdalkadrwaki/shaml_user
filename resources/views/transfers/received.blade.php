...
<x-app-layout>
    ...
    <div class="container mt-4" style="width: 98%">
        <!-- صناديق العملات على عرض الكونتير بالكامل -->
            ...
            <table class="myTable table-auto w-full border border-gray-300 shadow-md overflow-hidden"
                ...
                <thead class="bg-gray-200 text-gray-700">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-center w-72">الإجراءات</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($receivedTransfers as $transfer)
                        <tr class="text-center text-gray-600 hover:bg-gray-100 transition {{ $transfer->status === 'Frozen' ? 'bg-gray-300' : '' }}"
                            ...
                            <td class="py-2 px-4 border-b">
                                ...
                                <div
                                    style="color: {{ $transfer->currency ? ($transfer->currency->name_ar == 'تركي' ? 'red' : ($transfer->currency->name_ar == 'دولار' ? 'green' : 'inherit')) : 'inherit' }};">
                            ...
                            <td class="py-2 px-4 border-b text-center">
                                ...
                                <div
                                    style="color: {{ $transfer->receivedCurrency ? ($transfer->receivedCurrency->name_ar == 'تركي' ? 'red' : ($transfer->receivedCurrency->name_ar == 'دولار' ? 'green' : 'inherit')) : 'inherit' }};">
        ...
        <!-- باقي الكود الخاص بالمودال والإجراءات -->
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content bg-white rounded-lg shadow-xl">
                    <div class="modal-header bg-gray-100 p-4 rounded-t-lg text-center">
                        <h5 id="deliverTransferModalLabel" class="modal-title text-xl font-semibold text-gray-800">تسليم
                            الحوالة</h5>
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div id="transferInfo"
                            ...
                            <div class="text-center space-y-2 col-span-1">
                                <span
                                    class="block bg-white text-blue-600 text-sm font-bold py-1 rounded-lg shadow-sm">الجهة</span>
                            ...
                            <div class="text-center space-y-2 col-span-1">
                                <span
                                    class="block bg-white text-blue-600 text-sm font-bold py-1 rounded-lg shadow-sm">المستفيد</span>
                                <span id="modal_recipient_name" class="block text-gray-700 font-medium"></span>
                            </div>
                            <div class="text-center space-y-2 col-span-1">
                                <span
                                    class="block bg-white text-blue-600 text-sm font-bold py-1 rounded-lg shadow-sm">المبلغ</span>
                            ...
                            <div class="flex flex-col gap-4">
                                ...
                                <div class="mt-2 flex gap-2">
                                    <button id="captureBtn"
                                        class="bg-gray-500 hover:bg-gray-700 text-white px-4 py-2 rounded-lg w-full">التقاط
                                        الصورة من الكاميرا</button>
                                    <button id="chooseFileBtn"
                                        class="bg-gray-500 hover:bg-gray-700 text-white px-4 py-2 rounded-lg w-full">اختيار
                                        صورة من الملفات</button>
                    ...
                    <div class="modal-footer bg-gray-100 p-1 rounded-b-lg flex justify-end gap-2">
                        ...
                        <button type="button" id="deliverTransferBtn"
                            class="bg-green-500 hover:bg-green-700 text-white px-4 py-2 rounded-lg">تسليم
                            الحوالة</button>
                    </div>
                </div>
            </div>
