<x-app-layout>
    ...
    <div class="py-6 mt-1">
        <div class="container p-6">
            ...
            <div id="imageModal"
                class="fixed inset-0 z-50 bg-black bg-opacity-90 flex items-center justify-center p-4 hidden ">
                <div class="relative bg-white rounded-lg shadow-2xl p-6 max-w-2xl w-full">
                    ...
                    <div class="flex justify-between mt-6 space-x-4 w-full">
                        ...
                        <button onclick="downloadImage()"
                            class="flex-1 bg-green-500 text-white px-6 py-2 rounded-lg">تنزيل
                            الصورة</button>
            ...
            <div class="container mt-4">
                <div class="bg-white p-4 rounded-lg shadow-lg">
                    <table
                        class=" myTable table-auto w-full border border-gray-300 rounded-lg shadow-md overflow-hidden display"
                        style="direction: rtl;">
                            ...
                            @foreach ($transfers as $transfer)
                                <tr class="text-center text-gray-600 hover:bg-gray-100 transition">
                                    ...
                                    <td class="py-2 px-4 border-b font-bold text-blue-500 text-center  ">
                                        ...
                                        <div>
                                            <button
                                                class="hover:bg-gray-300 text-black px-3 py-1 rounded view-image-btn"
                                                data-id="{{ $transfer->id }}">
                                                طباعة
                                            </button>
                                        </div>
                                    ...
                                    <td class="py-2 px-4 border-b text-center ">
                                        <div class="flex justify-center items-center gap-1">
                                            @if ($transfer->status === 'Pending')
                                                <button
                                                    class="text-black px-2 border-2 border-gray-300 py-1 rounded edit-btn"
                                                    data-id="{{ $transfer->id }}"
                                                    data-name="{{ $transfer->recipient_name }}"
                                            ...
                                            @if ($transfer->status === 'Delivered')
                                                <button
                                                    class="text-white bg-indigo-500 px-2 py-1 rounded view-details-btn"
                                                    data-id="{{ $transfer->id }}">
                                                    التفاصيل
                                                </button>
                                            @endif
